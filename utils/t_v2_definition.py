...
# -- Hyperparameters for V2 Model --
MAX_LEN = 250        
EMBED_SIZE = 128     
NUM_HEADS = 8        
NUM_ENCODER_LAYERS = 5  # upgraded from 3 to 5
NUM_DECODER_LAYERS = 5  # upgraded from 3 to 5
HIDDEN_DIM = 512
...
# -- Seq2Seq Transformer Model Definition (V2) --
...
def encode_sentence(s: str, stoi: dict, max_len: int = MAX_LEN):
    """V2 encoding function with robust token handling"""
...
def predict_regex_to_e_nfa(s: str, model: Seq2SeqTransformer, stoi: dict, itos: dict,
    ...
    """V2 prediction function adapted from the notebook"""
    model.eval()
